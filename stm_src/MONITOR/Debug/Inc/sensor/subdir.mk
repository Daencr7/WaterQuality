...
Inc/sensor/%.o Inc/sensor/%.su Inc/sensor/%.cyclo: ../Inc/sensor/%.c Inc/sensor/subdir.mk
...
clean: clean-Inc-2f-sensor

clean-Inc-2f-sensor:
	-$(RM) ./Inc/sensor/sensor.cyclo ./Inc/sensor/sensor.d ./Inc/sensor/sensor.o ./Inc/sensor/sensor.su

.PHONY: clean-Inc-2f-sensor
